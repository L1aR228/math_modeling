...
ball, = plt.plot([], [], 'o', color='blue')  # Земля
ball_line, = plt.plot([], [], '-', color='blue')

ball2, = plt.plot([], [], 'o', color='gray')  # Меркурий
ball_line2, = plt.plot([], [], '-', color='gray')

ball3, = plt.plot([], [], 'o', color='orange')  # Венера
ball_line3, = plt.plot([], [], '-', color='orange')

ball4, = plt.plot([], [], 'o', color='red')  # Марс
ball_line4, = plt.plot([], [], '-', color='red')

ball5, = plt.plot([], [], 'o', color='brown')  # Юпитер
ball_line5, = plt.plot([], [], '-', color='brown')
...
ani = FuncAnimation(fig, animate, frames=300, interval=60)
